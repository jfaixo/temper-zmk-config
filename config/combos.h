...
/ {
  combos {
    ...
    // Modifiers
    COMBO(combo_l_ctrl,             &smart_mod LCTRL LCTRL,   LM4 LM3,      35,   ALL_LAYERS)
    COMBO(combo_l_shift,            &smart_mod LSHIFT LSHIFT, LM3 LM2,      35,   ALL_LAYERS)
    COMBO(combo_caps_word,          &caps_word,               LB3 LB2,      35,   ALL_LAYERS)
    COMBO(combo_l_alt,              &smart_mod LALT LALT,     LM2 LM1,      35,   ALL_LAYERS)
    COMBO(combo_l_gui,              &smart_mod LGUI LGUI,     LB2 LB1,      35,   ALL_LAYERS)
    ...
    COMBO(combo_dash,               &kp FR_MINUS,             RM3 RM4,      35,   ALL_LAYERS)
    COMBO(combo_underscore,         &kp FR_UNDERSCORE,        RB3 RB4,      35,   ALL_LAYERS)
